...
**Описание:** При выборе региона "Москва и МО" отображаются результаты из Санкт-Петербурга.  
**Приоритет:** High  
...
**Описание:** В топе результатов отображаются устаревшие объявления (2016 год) при сортировке "Сначала новые".  
**Приоритет:** High  
...
**Описание:** В карточке аренды указана "доставка от 1 дня".  
**Приоритет:** Low  
